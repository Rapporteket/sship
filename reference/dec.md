...
secure_secret_file <-
  enc(filename = file.path(wd, "secret.rds"),
      pubkey_holder = NULL,
      pubkey = pubkey)
#> sship: Content encrypted and ready for shipment: /tmp/RtmptvEk6N/secret.rds__20260302_112921.tar.gz
...
secret_file <-
  dec(tarfile = secure_secret_file,
      ...
      target_dir = wd)
#> sship: Decrypted file written to /tmp/RtmptvEk6N/secret.rds
```
